...
(function() {
  ...
  var Github = function(options) {
    ...
    Github.User = function() {
      ...
      // ------
      this.me = function(cb) {
        _request("GET", "/user", null, function(err, res){ cb(err, res); });
      };
    ...
    Github.Repository = function(options) {
      ...
      // Create a new file
      this.postContents = function(branch, path, content, message, cb) {
          var data = {
              branch: branch,
              message: message,
              content: btoa(content) // TODO: UTF-8 content will break!
          };
          return _request("PUT", repoPath + "/contents/" + path, data, cb);
      }
